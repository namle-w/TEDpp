...
for vid, path in enumerate(model_list):
    ...
    if len(poison_indices) == 0:
        ...
        if args.method == 'pca':
            ...
            visualizer = UMAP(n_components=2)
        ...
        feats_np = class_clean_features.numpy()
        ...
        labels = [0] * num_clean + [1] * num_poisoned
        ...
        tmp_labels = [0] * num_clean + [1] * num_poisoned
