...
if args.dataset == 'gtsrb':
    ...
    train_set = CelebA_attr('./data/celeba', 'train', data_transform, download=False)
    img_size = 64
    num_classes = 8
    ...
    clean_set = datasets.ImageFolder(os.path.join(os.path.join(data_dir, 'tinyimagenet200'), 'val'), data_transform)
