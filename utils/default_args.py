parser_choices = {
    ...
    'dataset': ['gtsrb', 'cifar10', 'cifar100', 'imagenette', 'celeba', 'ember', 'imagenet', 'imagenet50', 'imagenet100', 'imagenet200', 'mnist', 'tinyimagenet200'],
    'poison_type': [  # Poisoning attacks
        ...
        # Other attacks
        'trojannn', 'BadEncoder', 'SRA', 'bpp', 'WB', 'SSDT', 'Mirror', 'radialblend'],
    ...
    'defense': ['ABL', 'NC', 'STRIP', 'FP', 'NAD', 'SentiNet', 'ScaleUp', 'SEAM', 'SFT', 'NONE', 'Frequency', 'AC', 'moth', 'IBAU', 'ANP', 'FeatureRE', 'AWM', 'RNP', 'CD', 'BaDExpert', 'IBD_PSC', 'TED', 'FOLD', 'TEDPLUS', 'EXP'],
}
